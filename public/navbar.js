        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav">
              ...
              <li className="nav-item" id="li-createaccount" style={{display:'none'}}>
              ...
              <li className="nav-item" id="li-alldata" style={{display:'none'}}>
              ...
              <li className="nav-item" id="li-deposit" style={{display:'none'}}>
              ...
              <li className="nav-item" id="li-withdraw" style={{display:'none'}}>
